...
namespace Urun_Analizi
{
    public partial class Form1 : Form
    {
        ...
        public void Classify()
        {
            ...
            ConverterUtils.DataSource source2 = new ConverterUtils.DataSource("C:\\Users\\mehme\\Desktop\\UrunPredict.arff");
           ...
           /* weka.classifiers.lazy.IBk ibk = new weka.classifiers.lazy.IBk();
            ...
            //Yeni sınıflandırılan verinin train veri setine eklenmesi 
        ...
        private void btnClassify_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                StreamWriter Kayit = new StreamWriter("C:\\Users\\mehme\\Desktop\\UrunPredict.arff");
